// Instagram Number Checker API — browser/JavaScript example.
// Workflow: submit a file of E.164 numbers -> poll status -> download results.
// Docs: https://docs.checknumber.ai/instagram-bulk-number-checker
//
...
const TASK_TYPE = "instagram"; // instagram | instagram_email
...
async function checkInstagram(file) {
...
//   const url = await checkInstagram(e.target.files[0]);
